...
const HeroDesignTest: React.FC = () => {
    ...
    return (
        <section id="home" className="relative min-h-screen flex items-center justify-center pt-24 pb-12 overflow-hidden bg-background">
            ...
            <div className="absolute top-32 left-4 md:left-10 hidden lg:block font-mono text-[10px] text-primary/60 space-y-2 pointer-events-none">
            ...
            <div className="absolute bottom-32 right-4 md:right-10 hidden lg:block font-mono text-[10px] text-primary/60 text-right pointer-events-none">
            ...
            <div className="container mx-auto px-6 relative z-10 text-center">
                ...
                >
                    <div className="inline-flex items-center gap-3 px-3 py-0.5 mb-6 border border-primary/50 bg-primary/10 text-primary text-[8px] md:text-[10px] font-mono tracking-[0.2em] md:tracking-[0.4em] uppercase">
                        <span className="w-1.5 h-1.5 bg-primary rounded-full animate-ping" />
                        SYSTEM ONLINE // v4.0.2
                    </div>
                </motion.div>

                <h1 className="text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-orbitron font-black leading-tight sm:leading-none mb-6 tracking-tighter uppercase glitch-text">
                    <motion.span
                ...
                >
                    <button
                        ...
                        className="group relative w-full sm:w-auto overflow-hidden px-8 py-3.5 md:px-12 md:py-5 bg-primary text-primary-foreground font-orbitron font-bold text-xs md:text-sm tracking-widest hover:scale-105 transition-all duration-300 cursor-pointer"
                    >
                    ...
                    <button
                        ...
                        className="w-full sm:w-auto px-8 py-3.5 md:px-12 md:py-5 border-2 border-primary text-primary font-orbitron font-bold text-xs md:text-sm tracking-widest hover:bg-primary/10 transition-all duration-300 neon-border cursor-pointer uppercase"
                    >
                        About Me
                    </button>
                </motion.div>
            ...
            <div className="absolute bottom-6 md:bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 pointer-events-none">
                <span className="font-mono text-[8px] text-primary tracking-[0.5em] uppercase">Scroll</span>
                <div className="w-[1.5px] h-8 md:h-12 bg-gradient-to-b from-primary via-primary/50 to-transparent" />
            </div>
        </section>
    );
};
